...
import { screenToWorld, getRenderScale, worldToScreen } from "./viewport.js?v=0.32.3";
import {
...
import { circuitBodyPolygon, setSnapPreview } from "./render.js?v=0.32.3";
import { resolveEndpointSnap } from "./snap.js?v=0.32.3";
import { applyNewObjectStyleDefaults } from "./style-mode.js?v=0.32.3";
import { measureFormula, renderFormula, fontOf } from "./formula.js?v=0.32.3";
