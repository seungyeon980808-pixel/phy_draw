...
import { rebuildGroups } from "./transform.js?v=0.32.4";
import { screenToWorld } from "./viewport.js?v=0.32.4";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.32.4";
import { DEFAULT_TEXT_SIZE_MM } from "./state.js?v=0.32.4";
