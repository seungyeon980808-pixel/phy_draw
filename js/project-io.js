...
import { rebuildGroups } from "./transform.js?v=0.36.2";
import { screenToWorld } from "./viewport.js?v=0.36.2";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.36.2";
import { DEFAULT_TEXT_SIZE_MM, DEFAULT_TEXT_FONT } from "./state.js?v=0.36.2";
