...
import { rebuildGroups } from "./transform.js?v=0.28.0";
import { screenToWorld } from "./viewport.js?v=0.28.0";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.28.0";
