...
import { state } from "./state.js?v=0.17.10";
import { render } from "./render.js?v=0.17.10";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.17.10";
import { initTools } from "./tools.js?v=0.17.10";
import { initTransform, undo, redo } from "./transform.js?v=0.17.10";
import { initInspector } from "./inspector.js?v=0.17.10";
import { initProjectIO } from "./project-io.js?v=0.17.10";
import { initExportDialog } from "./export-dialog.js?v=0.17.10";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.17.10";
import { initSettings } from "./settings.js?v=0.17.10";
import { initImageObjectify } from "./image-objectify.js?v=0.17.10";
import { initTemplates } from "./templates.js?v=0.17.10";
import { initObjectSearch } from "./search.js?v=0.17.10";
...
console.info(
  "[5E v0.17.10] Pick R (or press R), drag on the canvas to draw a\n" +
