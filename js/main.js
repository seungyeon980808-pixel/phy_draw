...
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.16.3";
import { initTools } from "./tools.js?v=0.16.3";
import { initTransform, undo, redo } from "./transform.js?v=0.16.3";
...
import { initRuler, setRulerVisible } from "./ruler.js?v=0.16.3";
import { initSettings } from "./settings.js?v=0.16.3";
import { initImageObjectify } from "./image-objectify.js?v=0.16.3";
import { initTemplates } from "./templates.js?v=0.16.3";
import { initObjectSearch } from "./search.js?v=0.16.3";
...
console.info(
  "[PhysicsExamDrawer v0.16.3] Pick R (or press R), drag on the canvas to draw a\n" +
