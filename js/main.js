...
import { render } from "./render.js?v=0.17.5";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.17.5";
import { initTools } from "./tools.js?v=0.17.5";
import { initTransform, undo, redo } from "./transform.js?v=0.17.5";
import { initInspector } from "./inspector.js?v=0.17.5";
import { initProjectIO } from "./project-io.js?v=0.17.5";
import { initExportDialog } from "./export-dialog.js?v=0.17.5";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.17.5";
import { initSettings } from "./settings.js?v=0.17.5";
import { initImageObjectify } from "./image-objectify.js?v=0.17.5";
import { initTemplates } from "./templates.js?v=0.17.5";
import { initObjectSearch } from "./search.js?v=0.17.5";
...
console.info(
  "[5E v0.17.5] Pick R (or press R), drag on the canvas to draw a\n" +
