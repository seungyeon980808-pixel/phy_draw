...
import { state } from "./state.js?v=0.36.4";
import { render } from "./render.js?v=0.36.4";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.36.4";
import { initTools } from "./tools.js?v=0.36.4";
import { initTransform, undo, redo } from "./transform.js?v=0.36.4";
import { initInspector } from "./inspector.js?v=0.36.4";
import { initProjectIO } from "./project-io.js?v=0.36.4";
import { initExportDialog } from "./export-dialog.js?v=0.36.4";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.36.4";
import { initSettings } from "./settings.js?v=0.36.4";
import { initImageObjectify } from "./image-objectify.js?v=0.36.4";
import { initImageImportMock } from "./image-import-mock.js?v=0.36.4";
import { initTemplates } from "./templates.js?v=0.36.4";
import { initObjectSearch } from "./search.js?v=0.36.4";
...
console.info(
  "[시범공개] [5E v0.36.4] Pick R (or press R), drag on the canvas to draw a\n" +
