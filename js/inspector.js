...
import { TEXT_FONTS, DEFAULT_TEXT_FONT, mmToPt, ptToMm } from "./state.js?v=0.17.1";
import { openFontModalForSelection } from "./tools.js?v=0.17.1";
import {
  getObjectStyleMode,
  prepareObjectStyleModeSwitch,
  resolveObjectStyle,
} from "./style-mode.js?v=0.17.1";
